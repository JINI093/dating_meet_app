...
class GiftCardCatalogScreen extends StatefulWidget {
  ...
  const GiftCardCatalogScreen(
      {Key? key, required this.userPoint, required this.userEmail})
      : super(key: key);
...
class _GiftCardCatalogScreenState extends State<GiftCardCatalogScreen> {
  ...
  void initState() {
    ...
    _pointController = TextEditingController(text: widget.userPoint.toString());
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Image.asset('assets/icons/ic_gift.png'),
            ),
