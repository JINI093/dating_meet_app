...
class ReceivedActionBottomSheet extends ConsumerWidget {
  final LikeModel like;
  
  const ReceivedActionBottomSheet({
    super.key,
    required this.like,
  });
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () async {
                // 프로필 해제 처리
                await ref.read(likesProvider.notifier).addUnlockedProfile(like.fromUserId);
