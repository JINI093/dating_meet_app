...
class SuperChatPackage {
  ...
  factory SuperChatPackage.fromJson(Map<String, dynamic> json) {
    return SuperChatPackage(
      id: json['id'] as int,
...
class SuperChatTransaction {
  ...
  factory SuperChatTransaction.fromJson(Map<String, dynamic> json) {
    return SuperChatTransaction(
      id: json['id'] as String,
